...
$_mod.installed("marko-js$1.0.0", "marko", "4.1.2");
$_mod.main("/marko$4.1.2/runtime/vdom", "");
$_mod.installed("marko$4.1.2", "events-light", "1.0.5");
...
$_mod.def("/marko$4.1.2/runtime/vdom/VNode", function(require, exports, module, __filename, __dirname) { /* jshint newcap:false */
function VNode() {}
...
$_mod.installed("marko$4.1.2", "raptor-util", "3.2.0");
...
$_mod.def("/marko$4.1.2/runtime/vdom/VComment", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.1.2/runtime/vdom/VNode'/*'./VNode'*/);
...
$_mod.def("/marko$4.1.2/runtime/vdom/VDocumentFragment", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.1.2/runtime/vdom/VNode'/*'./VNode'*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*'raptor-util/inherit'*/);
...
$_mod.def("/marko$4.1.2/runtime/vdom/VElement", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.1.2/runtime/vdom/VNode'/*'./VNode'*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*'raptor-util/inherit'*/);
var extend = require('/raptor-util$3.2.0/extend'/*'raptor-util/extend'*/);
...
$_mod.def("/marko$4.1.2/runtime/vdom/VText", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.1.2/runtime/vdom/VNode'/*'./VNode'*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*'raptor-util/inherit'*/);
...
$_mod.def("/marko$4.1.2/runtime/vdom/vdom", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.1.2/runtime/vdom/VNode'/*'./VNode'*/);
var VComment = require('/marko$4.1.2/runtime/vdom/VComment'/*'./VComment'*/);
var VDocumentFragment = require('/marko$4.1.2/runtime/vdom/VDocumentFragment'/*'./VDocumentFragment'*/);
var VElement = require('/marko$4.1.2/runtime/vdom/VElement'/*'./VElement'*/);
var VText = require('/marko$4.1.2/runtime/vdom/VText'/*'./VText'*/);
var FLAG_IS_TEXTAREA = 2;
...
$_mod.remap("/marko$4.1.2/components/util", "/marko$4.1.2/components/util-browser");
$_mod.remap("/marko$4.1.2/components/init-components", "/marko$4.1.2/components/init-components-browser");
$_mod.installed("marko$4.1.2", "warp10", "1.3.4");
...
$_mod.def("/marko$4.1.2/components/bubble", function(require, exports, module, __filename, __dirname) { module.exports = [
    /* Mouse Events */
    'click',
    'dblclick',
    'mousedown',
...
$_mod.def("/marko$4.1.2/components/event-delegation", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.1.2/components/util-browser'/*'./util'*/);
...
function attachBubbleEventListeners(doc) {
    ...
    require('/marko$4.1.2/components/bubble'/*'./bubble'*/).forEach(function addBubbleHandler(eventType) {
...
$_mod.def("/marko$4.1.2/runtime/events", function(require, exports, module, __filename, __dirname) { var EventEmitter = require('/events-light$1.0.5/src/index'/*'events-light'*/);
module.exports = new EventEmitter();
});
$_mod.def("/marko$4.1.2/components/nextRepeatedId", function(require, exports, module, __filename, __dirname) { var REPEATED_ID_KEY = '$rep';
...
$_mod.remap("/marko$4.1.2/components/registry", "/marko$4.1.2/components/registry-browser");
$_mod.remap("/marko$4.1.2/components/loadComponent", "/marko$4.1.2/components/loadComponent-dynamic");
$_mod.def("/marko$4.1.2/components/loadComponent-dynamic", function(require, exports, module, __filename, __dirname) { 'use strict';
...
$_mod.def("/marko$4.1.2/components/State", function(require, exports, module, __filename, __dirname) { var extend = require('/raptor-util$3.2.0/extend'/*'raptor-util/extend'*/);
...
$_mod.main("/marko$4.1.2", "runtime/index");
$_mod.remap("/marko$4.1.2/runtime/env-init", false);
$_mod.def("/marko$4.1.2/runtime/createOut", function(require, exports, module, __filename, __dirname) { var actualCreateOut;
...
$_mod.main("/marko$4.1.2/runtime/loader", "");
$_mod.remap("/marko$4.1.2/runtime/loader/index", "/marko$4.1.2/runtime/loader/index-browser");
$_mod.remap("/marko$4.1.2/runtime/loader/index-browser", "/marko$4.1.2/runtime/loader/index-browser-dynamic");
$_mod.def("/marko$4.1.2/runtime/loader/index-browser-dynamic", function(require, exports, module, __filename, __dirname) { 'use strict';
...
$_mod.def("/marko$4.1.2/runtime/index", function(require, exports, module, __filename, __dirname) { 'use strict';
({})/*require('./env-init')*/; // no-op in the browser, but enables extra features on the server

exports.createOut = require('/marko$4.1.2/runtime/createOut'/*'./createOut'*/);
exports.load = require('/marko$4.1.2/runtime/loader/index-browser-dynamic'/*'./loader'*/);
exports.events = require('/marko$4.1.2/runtime/events'/*'./events'*/);
});
$_mod.installed("marko$4.1.2", "listener-tracker", "2.0.0");
...
$_mod.def("/marko$4.1.2/components/update-manager", function(require, exports, module, __filename, __dirname) { 'use strict';
...
$_mod.main("/marko$4.1.2/morphdom", "");
$_mod.def("/marko$4.1.2/morphdom/specialElHandlers", function(require, exports, module, __filename, __dirname) { function syncBooleanAttrProp(fromEl, toEl, name) {
...
$_mod.def("/marko$4.1.2/morphdom/index", function(require, exports, module, __filename, __dirname) { 'use strict';
var defaultDoc = typeof document == 'undefined' ? undefined : document;
var specialElHandlers = require('/marko$4.1.2/morphdom/specialElHandlers'/*'./specialElHandlers'*/);

var morphAttrs = require('/marko$4.1.2/runtime/vdom/VElement'/*'../runtime/vdom/VElement'*/).$__morphAttrs;
...
$_mod.def("/marko$4.1.2/components/Component", function(require, exports, module, __filename, __dirname) { 'use strict';
/* jshint newcap:false */

var domInsert = require('/marko$4.1.2/runtime/dom-insert'/*'../runtime/dom-insert'*/);
var marko = require('/marko$4.1.2/runtime/index'/*'../'*/);
var componentsUtil = require('/marko$4.1.2/components/util-browser'/*'./util'*/);
var componentLookup = componentsUtil.$__componentLookup;
...
var RenderResult = require('/marko$4.1.2/runtime/RenderResult'/*'../runtime/RenderResult'*/);
var SubscriptionTracker = require('/listener-tracker$2.0.0/lib/listener-tracker'/*'listener-tracker'*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*'raptor-util/inherit'*/);
var updateManager = require('/marko$4.1.2/components/update-manager'/*'./update-manager'*/);
var morphdom = require('/marko$4.1.2/morphdom/index'/*'../morphdom'*/);
var eventDelegation = require('/marko$4.1.2/components/event-delegation'/*'./event-delegation'*/);
...
$_mod.def("/marko$4.1.2/components/defineComponent", function(require, exports, module, __filename, __dirname) { 'use strict';
/* jshint newcap:false */

var BaseState = require('/marko$4.1.2/components/State'/*'./State'*/);
var BaseComponent = require('/marko$4.1.2/components/Component'/*'./Component'*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*'raptor-util/inherit'*/);
...
$_mod.def("/marko$4.1.2/components/registry-browser", function(require, exports, module, __filename, __dirname) { var loadComponent = require('/marko$4.1.2/components/loadComponent-dynamic'/*'./loadComponent'*/);
var defineComponent = require('/marko$4.1.2/components/defineComponent'/*'./defineComponent'*/);
...
$_mod.def("/marko$4.1.2/components/ComponentDef", function(require, exports, module, __filename, __dirname) { 'use strict';
var nextRepeatedId = require('/marko$4.1.2/components/nextRepeatedId'/*'./nextRepeatedId'*/);
var repeatedRegExp = /\[\]$/;
var componentUtil = require('/marko$4.1.2/components/util-browser'/*'./util'*/);
var nextComponentId = componentUtil.$__nextComponentId;
var attachBubblingEvent = componentUtil.$__attachBubblingEvent;

var extend = require('/raptor-util$3.2.0/extend'/*'raptor-util/extend'*/);
var registry = require('/marko$4.1.2/components/registry-browser'/*'./registry'*/);
...
$_mod.def("/marko$4.1.2/components/init-components-browser", function(require, exports, module, __filename, __dirname) { 'use strict';
var warp10Finalize = require('/warp10$1.3.4/finalize'/*'warp10/finalize'*/);
var eventDelegation = require('/marko$4.1.2/components/event-delegation'/*'./event-delegation'*/);
var win = window;
var defaultDocument = document;
var events = require('/marko$4.1.2/runtime/events'/*'../runtime/events'*/);
var componentsUtil = require('/marko$4.1.2/components/util-browser'/*'./util'*/);
var componentLookup = componentsUtil.$__componentLookup;
var getElementById = componentsUtil.$__getElementById;
var ComponentDef = require('/marko$4.1.2/components/ComponentDef'/*'./ComponentDef'*/);
...
$_mod.def("/marko$4.1.2/components/boot", function(require, exports, module, __filename, __dirname) { require('/marko$4.1.2/components/init-components-browser'/*'./init-components'*/).$__initServerRendered();
});
$_mod.run("/marko$4.1.2/components/boot");
$_mod.def("/marko$4.1.2/components/util-browser", function(require, exports, module, __filename, __dirname) { var markoGlobal = window.$MG || (window.$MG = {
    uid: 0
});
...
$_mod.def("/marko$4.1.2/runtime/dom-insert", function(require, exports, module, __filename, __dirname) { var extend = require('/raptor-util$3.2.0/extend'/*'raptor-util/extend'*/);
var componentsUtil = require('/marko$4.1.2/components/util-browser'/*'../components/util'*/);
var destroyComponentForEl = componentsUtil.$__destroyComponentForEl;
var destroyElRecursive = componentsUtil.$__destroyElRecursive;
...
$_mod.def("/marko$4.1.2/runtime/RenderResult", function(require, exports, module, __filename, __dirname) { var domInsert = require('/marko$4.1.2/runtime/dom-insert'/*'./dom-insert'*/);
var EMPTY_ARRAY = [];
...
$_mod.def("/marko$4.1.2/runtime/vdom/AsyncVDOMBuilder", function(require, exports, module, __filename, __dirname) { var EventEmitter = require('/events-light$1.0.5/src/index'/*'events-light'*/);
var vdom = require('/marko$4.1.2/runtime/vdom/vdom'/*'./vdom'*/);
...
var RenderResult = require('/marko$4.1.2/runtime/RenderResult'/*'../RenderResult'*/);
...
$_mod.def("/marko$4.1.2/runtime/renderable", function(require, exports, module, __filename, __dirname) { var defaultCreateOut = require('/marko$4.1.2/runtime/createOut'/*'./createOut'*/);
var extend = require('/raptor-util$3.2.0/extend'/*'raptor-util/extend'*/);
...
$_mod.def("/marko$4.1.2/runtime/vdom/index", function(require, exports, module, __filename, __dirname) { 'use strict';
// helpers provide a core set of various utility methods
// that are available in every template
var AsyncVDOMBuilder = require('/marko$4.1.2/runtime/vdom/AsyncVDOMBuilder'/*'./AsyncVDOMBuilder'*/);
var makeRenderable = require('/marko$4.1.2/runtime/renderable'/*'../renderable'*/);
...
require('/marko$4.1.2/runtime/createOut'/*'../createOut'*/).$__setCreateOut(createOut);

});
$_mod.def("/marko$4.1.2/vdom", function(require, exports, module, __filename, __dirname) { module.exports = require('/marko$4.1.2/runtime/vdom/index'/*'./runtime/vdom'*/);
});
$_mod.def("/marko-js$1.0.0/hello.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.1.2 - DO NOT EDIT
"use strict";

var marko_template = module.exports = require('/marko$4.1.2/vdom'/*"marko/vdom"*/).t();
...
$_mod.def("/marko-js$1.0.0/client", function(require, exports, module, __filename, __dirname) { var helloComponent = require('/marko-js$1.0.0/hello.marko'/*'./hello'*/);
 
helloComponent.renderSync({ name:'Marko' })
    .appendTo(document.body);

});
$_mod.run("/marko-js$1.0.0/client");